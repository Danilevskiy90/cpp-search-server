//Реализация класса, осуществляющего разбиение на страницы
//Вызывается функция Paginate, принимающая результаты поиска и размер страницы
//Возвращается объект класса, разбивший документы по страницам
